...
import { Input, Select, DatePicker, Upload, message, Tooltip, Skeleton } from 'antd'
...
import { updateJob, uploadJobPicture } from '@/api/job'
...
export default function EditJobPage() {
  ...
  const onFinish = async (values: JobFormValues) => {
    ...
    const { error } = await updateJob(jobId, jobData as any)
    
    if (error) {
      messageApi.error('Erreur lors de la modification du Job')
    } else {
      messageApi.success('Job modifié avec succès !')
  ...
  return (
    <div className="flex-1 p-[32px] h-full overflow-y-auto bg-white font-['Inter',sans-serif]">
      ...
      <form onSubmit={handleSubmit(onFinish)}>
        {/* Top Header Section */}
        <div className="flex justify-between items-center mb-[48px]">
          <h1 className="text-[30px] font-medium text-[#101828] m-0">Edit</h1>
        ...
        <div className="max-w-[1100px]">
          ...
          <div className="flex justify-between items-start mb-[24px] border-b border-[#EAECF0] pb-[20px]">
            <div className="flex flex-col gap-[4px]">
              <h2 className="text-[18px] font-medium text-[#101828] m-0">Update Information</h2>
              <p className="text-[#667085] text-[14px] m-0">Modify the job details and requirements.</p>
            </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex py-[24px] border-b border-[#EAECF0]">
              <div className="w-[280px]">
                <span className="text-[14px] font-medium text-[#344054]">Job Picture</span>
                <p className="text-[#667085] text-[13px] mt-1 m-0">Update the visual for the job listing.</p>
              </div>
