...
import { updateJob, uploadJobPicture } from '@/lib/jobService'
...
export default function EditJobPage() {
  ...
  useEffect(() => {
    ...
    loadJob()
  }, [jobId, form, router, messageApi])

  const handleFinish = async (values: any) => {
    const jobData = {
      title: values.title,
      category: values.category || 'Dummy',
  ...
  return (
    <div className="flex-1 p-[24px] px-[28px] h-full overflow-y-auto bg-white">
      ...
      <div className="flex justify-between items-center mb-[32px]">
        <h1 className="text-[28px] font-bold text-[#101828] m-0">Edit Job</h1>
